...
def load_data():
    ...
    end_date = '2025-10-29' #keeping this on last successful run for sanity reasons
...
def q11(X, y, models):
    ...
    # ===========================
    print("\n" + "=" * 70)
    print("TRAIN MODELS AND EVALUATE ON TEST SET")
    print("=" * 70)
...
def main():
    ...
    #Implement models, calculate MSE, R2, MAE
    test_results, X_train, X_test, y_train, y_test = q11(X, y, models)
